                          ...
                          children: [
                            state.loggedInAdmin.image == null
                                ...
                                : FutureBuilder<String>(
                                    future: cubit
                                        .loadImage(state.loggedInAdmin.image),
                              ...
                              children: [
                                GlassmorphismContainer(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        state.loggedInAdmin.postsCount
                                            .toString(),
                                        style: TextStyle(
                                          fontSize: 22,
                                          fontFamily:
                                ...
                                GlassmorphismContainer(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        state.loggedInAdmin.iconssCount
                                            .toString(),
                                        style: TextStyle(
                                          fontSize: 22,
                                          fontFamily:
                          ...
                          child: GridView.builder(
                            ...
                            gridDelegate:
                                ...
                                SliverGridDelegateWithFixedCrossAxisCount(
                                    ...
                                    crossAxisSpacing: 10,
                                    mainAxisSpacing: 10),
                            itemBuilder: (ctx, index) => GlassmorphismContainer(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomAuthTextForm(
                      ...
                      controller: cubit.adminCubit.nameController,
                    ),
                    SizedBox(
                      height: screenSize.height * 0.008,
                    ),
                    ...
                    CustomAuthTextForm(
                      ...
                      width: screenSize.width * 0.35,
                      controller: cubit.adminCubit.emailController,
                    ),
                    SizedBox(
                      height: screenSize.height * 0.008,
                    ),
                    ...
                    CustomAuthTextForm(
                      ...
                      width: screenSize.width * 0.35,
                      controller: cubit.adminCubit.passwordController,
                    ),
                    SizedBox(
                    ...
                    Row(
                      ...
                      children: [
                        StreamBuilder<String?>(
                          stream:
                              cubit.adminCubit.imageUrlStreamController.stream,
                        ...
                        GlassmorphismContainer(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              await cubit.adminCubit.pickImage();
                    ...
                    GlassmorphismContainer(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          await cubit.adminCubit.createUser();
